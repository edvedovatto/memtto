...
import { createEntry, getContexts, getContextSettings, setContextIcon } from "@/lib/services/entries";
            ...
            <div className="flex gap-1.5">
              <div ref={contextRef} className="relative flex-1">
                ...
                {contextOpen && contexts.length > 0 && (
                  <div
                    className="absolute left-0 right-0 top-full z-50 mt-1 max-h-[160px] overflow-y-auto rounded-lg border border-border bg-surface py-1 shadow-lg"
                  >
                    {contexts.map((ctx) => (
                      <button
                        key={ctx}
